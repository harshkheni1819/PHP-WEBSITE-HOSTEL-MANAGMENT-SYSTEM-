...
<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $q = mysqli_query($con, "update admin_registration set password='$newpassword' where email='$email'");
       echo "update admin_registration set password='$newpassword' where email=$email";
