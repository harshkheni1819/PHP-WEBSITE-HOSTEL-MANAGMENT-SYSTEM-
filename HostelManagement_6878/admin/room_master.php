...
if(isset($_POST['btnins']))
{
    ...
    $dst="images/".$Photo;
    $q=mysqli_query($con,"insert into room_master values('','$Roomtype','$Photo')");
    if($q)
    {
...
?>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
      <input type="text" name="txtroomtype" placeholder="Enter Roomtype" class="col-xs-10 col-sm-5" required/>
    </div>
</div>
...
<?php
       ...
       while($row=mysqli_fetch_array($q))
       {
		...
		echo "<td colspan=2><a href=room_master_edit.php?x=$row[0]><image src=edit.png height=30 width=30></a>";
		echo "<a href=room_master_delete.php?x=$row[0]><image src=delete.png height=30 width=30></a>";
       echo"</tr>";
        }
        echo"</table>";
