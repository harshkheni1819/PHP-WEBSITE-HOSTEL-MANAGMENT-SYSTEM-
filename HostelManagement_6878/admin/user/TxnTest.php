...
<div class="container">
    ...
    ?>
                    <div class="d-flex justify-content-between mb-2">
                        ...
                        <p class="fs-14 fw-bold"><?php echo $totalmonths= $_SESSION['totalmonths'];?></p>
                    </div>
                    <div class="d-flex justify-content-between mb-2">
                        <p class="textmuted"></p>
                        <p class="fs-14 fw-bold"></p>
                    ...
                    <div class="d-flex justify-content-between mb-3">
                        ...
                        <div class="d-flex align-text-top "> <span class="fas fa-rupee-sign mt-2 pe-1 fs-18 "></span><span class="h4"><?php echo $total=$price*$totalmonths;?></span> </div>
                    </div>
                </div>
