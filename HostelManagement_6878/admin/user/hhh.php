...
<?php
					if(isset($_SESSION['loggedin']) && $_SESSION['loggedin']==true){
						...
						$loggedin= false;
										...
										if(!$loggedin)
										{
										echo'<li>  <a href="r.php"class="btn theme_btn button_hover" >Login</a> </li>';
										}
											if($loggedin)
											{

											echo '<li><a href="profile.php"class="btn theme_btn button_hover"> Profile </a></li>
											<li><a href="logout.php"class="btn theme_btn button_hover"> Log Out </a></li>';
