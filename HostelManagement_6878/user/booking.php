...
if(isset($_POST['submit']))
{
  ...
  $end_date = strtotime($checkout);
    ...
    $q=mysqli_query($con,"insert into booking values('','$roomid','$name','$address','$date','$dob','$checkin','$checkout','$email','$phoneno','$roomname','$booking_status')");
    if($q)
    {
    ...
    $roomid=$_GET['x'];
       ...
       while($row=mysqli_fetch_array($q))
       {
        ?>
                        ...
                        <div class="form-group">
                            <input class="form-control" type="text" name="roomname" placeholder="Name" value="<?php echo $row[1];?>">
