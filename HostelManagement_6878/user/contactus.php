...
<?php
  if(isset($_POST['btnins']))
  {
      ...
      $status = isset($_POST['status']) ? $_POST['status'] : '0'; // Default value to avoid error
  
      $q = mysqli_query($con, "INSERT INTO user_query (name, email, message, status) VALUES ('$name', '$email', '$message', '$status')");
