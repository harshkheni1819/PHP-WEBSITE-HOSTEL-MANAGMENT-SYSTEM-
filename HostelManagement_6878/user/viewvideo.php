<?php
        ...
        <div class="overlay bg-parallax" data-stellar-ratio="0.8" data-stellar-vertical-offset="0" data-background="about_banner.jpg"style="top: 500;"></div>
            ...
            <div class="container">
                <div class="page-cover text-center">
                    <h2 class="page-cover-tittle">MOREVIDEO</h2>
                    <ol class="breadcrumb">
                        <li><a href="index.php">VIDEO</a></li>
                        <li class="active">MOREVIDEO</li>
                    </ol>
                </div>
            </div>
        </section>
  ...
  <div class="widget-body">
							 <div class="widget-main" style='display: flex; justify-content: center;'>
								 <h1 class="header blue lighter bigger">	<b> VIEW VIDEO</b> </h1>
